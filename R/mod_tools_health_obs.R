...
mod_tools_health_obs_server <- function(id){
  moduleServer(id, function(input, output, session){
    ...
    observeEvent(input$selected, {
      iphra_try({
        ...
        iphra_message(
          ...
          origin = iphra_txt("Health Facility Obs Tool: Selection Sync")
        )
      },
      on_error = "warn",
      origin = iphra_txt("Health Facility Obs Tool: Selection Sync"),
      ...
      iphra_try({
        ...
        result <- iphra_try_step({
          ...
          iphra_message(
            ...
            origin = iphra_txt("Health Facility Obs Tool: Preset Objectives")
          )
        ...
        result <- iphra_try_step({
          ...
          iphra_message(
            iphra_txt("Health Facility Obs objectives preset applied successfully."),
            origin = iphra_txt("Health Facility Obs Tool: Preset Objectives")
          )
        ...
        result <- iphra_try_step({
          ...
          iphra_message(
            iphra_txt("Health Facility Obs objectives preset selection completed."),
            origin = iphra_txt("Health Facility Obs Tool: Preset Objectives")
          )
    ...
    observeEvent(input$preset_core_obs, {
      iphra_try({
        ...
        result <- iphra_try_step({
          iphra_message(
            iphra_txt("Validation checks passed (dummy mode)."),
            origin = iphra_txt("Health Facility Obs Tool: Preset Core")
          )
        ...
        result <- iphra_try_step({
          ...
          iphra_message(
            iphra_txt("Health Facility Obs core preset applied successfully."),
            origin = iphra_txt("Health Facility Obs Tool: Preset Core")
          )
        ...
        result <- iphra_try_step({
          iphra_message(
            iphra_txt("Health Facility Obs core preset selection completed."),
            origin = iphra_txt("Health Facility Obs Tool: Preset Core")
          )
    ...
    observeEvent(input$preset_full_obs, {
      iphra_try({
        ...
        result <- iphra_try_step({
          iphra_message(
            iphra_txt("Validation checks passed (dummy mode)."),
            origin = iphra_txt("Health Facility Observation Tool: Preset Full")
          )
        ...
        result <- iphra_try_step({
          ...
          iphra_message(
            iphra_txt("Full Health Facility Obs preset applied successfully."),
            origin = iphra_txt("Health Facility Obs Tool: Preset Full")
          )
        ...
        result <- iphra_try_step({
          iphra_message(
            iphra_txt("Full Health Facility Obs preset selection completed."),
            origin = iphra_txt("Health Facility Obs Tool: Preset Full")
          )
    ...
    observeEvent(input$export_tool, {
      iphra_try({
        if (!isTRUE(protocol_r()$.tool_health_facility_observation)) {
          shiny::showModal(shiny::modalDialog(
            title = iphra_txt("Export Health Facility Obs Tool"),
            iphra_txt("The Health Facility Obs tool has not been added to the protocol yet. Please add it from the Tool Design page before exporting."),
        ...
        shiny::showModal(shiny::modalDialog(
          title = iphra_txt("Export Health Facility Obs Tool"),
          shiny::tagList(
            shiny::p(iphra_txt("Click below to save the Health Facility Obs tool as an Excel workbook with three sheets: revised_survey, revised_choices, and revised_settings.")),
      ...
      on_error = "warn",
      origin = iphra_txt("Health Facility Obs Tool: Export"),
      hint = iphra_txt("Ensure the Health Facility Obs tool has been added to the protocol and exposes revised_survey / revised_choices / revised_settings.")
      )
    })
    ...
    output$download_tool <- shiny::downloadHandler(
      ...
      content = function(file) {
        ...
        iphra_message(
          iphra_txt("Health Facility Obs tool exported to Excel."),
          origin = iphra_txt("Health Facility Obs Tool: Export")
        )
      }
    )
