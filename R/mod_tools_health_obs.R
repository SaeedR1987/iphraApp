...
mod_tools_health_obs_ui <- function(id) {
  ns <- NS(id)
  tagList(
...
#'
#' @noRd
mod_tools_health_obs_server <- function(id){
  moduleServer(id, function(input, output, session){
    ...
    output$tool_present <- shiny::renderText({
      if (isTRUE(protocol_r()$.tool_health_facility_observation)) "true" else "false"
    })
    ...
    all_indicators <- shiny::reactive({
      ...
      bank <- protocol_r()$framework$modified_indicator_bank[
        protocol_r()$framework$modified_indicator_bank$tool == "obs_health_facility",
    ...
    output$summary_table <- shiny::renderTable({
      ...
      survey <- protocol_r()$tools$tool_obs_health_facility_iphra_v2$revised_survey
    ...
    observeEvent(input$sector_filter, {
      iphra_save_tool_field(
        protocol_r()$tools[["tool_obs_health_facility_iphra_v2"]],
    ...
    observeEvent(input$selected, {
      phrutils::phr_try({
        ...
        tool <- protocol_r()$tools[["tool_obs_health_facility_iphra_v2"]]
        if (!is.null(tool)) {
        ...
        protocol_r()$tools$tool_obs_health_facility_iphra_v2$filter_survey_by_indicator(indicator_codes = indicators_selected$indicator_code)
        ...
        phrutils::phr_message(
          ...
          origin = phrutils::phr_txt("Health Facility Obs Tool: Selection Sync")
        )
      },
      on_error = "warn",
      origin = phrutils::phr_txt("Health Facility Obs Tool: Selection Sync"),
    ...
    # Preset: Objectives
    observeEvent(input$preset_obj_health_facility_obs, {
      phrutils::phr_try({
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            ...
            origin = phrutils::phr_txt("Health Facility Obs Tool: Preset Objectives")
          )


        }, step = "mod_tools_health_facility_obs_server/observeEvent_preset_obj_health_facility_obs/Validation")
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            phrutils::phr_txt("Health Facility Obs objectives preset applied successfully."),
            origin = phrutils::phr_txt("Health Facility Obs Tool: Preset Objectives")
          )

        }, step = "mod_tools_health_facility_obs_server/observeEvent_preset_obj_health_facility_obs/Core Logic")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            phrutils::phr_txt("Health Facility Obs objectives preset selection completed."),
            origin = phrutils::phr_txt("Health Facility Obs Tool: Preset Objectives")
          )
        }, step = "mod_tools_health_facility_obs_server/observeEvent_preset_obj_health_facility_obs/Result Handling")
        if (phrutils::phr_failed(result)) return(result)
    ...
    observeEvent(input$preset_core_obs, {
      phrutils::phr_try({
        ...
        result <- phrutils::phr_try_step({
          phrutils::phr_message(
            phrutils::phr_txt("Validation checks passed (dummy mode)."),
            origin = phrutils::phr_txt("Health Facility Obs Tool: Preset Core")
          )
        }, step = "mod_tools_health_facility_obs_server/observeEvent_preset_core_health_facility_obs/Validation")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            phrutils::phr_txt("Health Facility Obs core preset applied successfully."),
            origin = phrutils::phr_txt("Health Facility Obs Tool: Preset Core")
          )
        ...
        }, step = "mod_tools_health_facility_obs_server/observeEvent_preset_core_health_facility_obs/Core Logic")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          phrutils::phr_message(
            phrutils::phr_txt("Health Facility Obs core preset selection completed."),
            origin = phrutils::phr_txt("Health Facility Obs Tool: Preset Core")
          )
        }, step = "mod_tools_health_facility_obs_server/observeEvent_preset_core_health_facility_obs/Result Handling")
        if (phrutils::phr_failed(result)) return(result)
    ...
    observeEvent(input$preset_full_obs, {
      phrutils::phr_try({
        ...
        result <- phrutils::phr_try_step({
          phrutils::phr_message(
            phrutils::phr_txt("Validation checks passed (dummy mode)."),
            origin = phrutils::phr_txt("Health Facility Observation Tool: Preset Full")
          )
        }, step = "mod_tools_health_facility_obs_server/observeEvent_preset_full_health_facility_obs/Validation")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            phrutils::phr_txt("Full Health Facility Obs preset applied successfully."),
            origin = phrutils::phr_txt("Health Facility Obs Tool: Preset Full")
          )

        }, step = "mod_tools_health_facility_obs_server/observeEvent_preset_full_health_facility_obs/Core Logic")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          phrutils::phr_message(
            phrutils::phr_txt("Full Health Facility Obs preset selection completed."),
            origin = phrutils::phr_txt("Health Facility Obs Tool: Preset Full")
          )
        }, step = "mod_tools_health_facility_obs_server/observeEvent_preset_full_health_facility_obs/Result Handling")
        if (phrutils::phr_failed(result)) return(result)
    ...
    observeEvent(input$export_tool, {
      phrutils::phr_try({
        if (!isTRUE(protocol_r()$.tool_health_facility_observation)) {
          shiny::showModal(shiny::modalDialog(
            title = phrutils::phr_txt("Export Health Facility Obs Tool"),
            phrutils::phr_txt("The Health Facility Obs tool has not been added to the protocol yet. Please add it from the Tool Design page before exporting."),
        ...
        shiny::showModal(shiny::modalDialog(
          title = phrutils::phr_txt("Export Health Facility Obs Tool"),
          shiny::tagList(
            shiny::p(phrutils::phr_txt("Click below to save the Health Facility Obs tool as an Excel workbook with three sheets: revised_survey, revised_choices, and revised_settings.")),
      ...
      on_error = "warn",
      origin = phrutils::phr_txt("Health Facility Obs Tool: Export"),
      hint = phrutils::phr_txt("Ensure the Health Facility Obs tool has been added to the protocol and exposes revised_survey / revised_choices / revised_settings.")
      )
    })

    output$download_tool <- shiny::downloadHandler(
      filename = function() {
        paste0("tool_obs_health_facility_iphra_v2",
      ...
      content = function(file) {
        ...
        sheets <- list(
          survey   = safe_df(protocol_r()$tools$tool_obs_health_facility_iphra_v2$revised_survey),
          choices  = safe_df(protocol_r()$tools$tool_obs_health_facility_iphra_v2$revised_choices),
          settings = safe_df(protocol_r()$tools$tool_obs_health_facility_iphra_v2$revised_settings)
        )

        writexl::write_xlsx(sheets, path = file)

        phrutils::phr_message(
          phrutils::phr_txt("Health Facility Obs tool exported to Excel."),
          origin = phrutils::phr_txt("Health Facility Obs Tool: Export")
        )
      }
    )
