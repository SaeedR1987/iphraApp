...
mod_tools_latrine_obs_ui <- function(id) {
  ns <- NS(id)
  tagList(
    ...
    shiny::conditionalPanel(
      ...
      shiny::fluidRow(
        shinydashboard::box(
          ...
          shiny::actionButton(ns("export_tool"), "Export Latrine Observation Kobo Tool", class = "btn-success"),
          shiny::actionButton(ns("export_tool_paper"), "Export Latrine Observation Paper Tool", class = "btn-success"),
...
#'
#' @noRd
mod_tools_latrine_obs_server <- function(id){
  moduleServer(id, function(input, output, session){
    ...
    output$tool_present <- shiny::renderText({
      if (isTRUE(protocol_r()$.tool_latrine_observation)) "true" else "false"
    })
    ...
    all_indicators <- shiny::reactive({
      ...
      bank <- protocol_r()$framework$modified_indicator_bank[
        protocol_r()$framework$modified_indicator_bank$tool == "obs_latrine",
    ...
    output$summary_table <- shiny::renderTable({
      ...
      survey <- protocol_r()$tools$tool_obs_latrine_iphra_v2$revised_survey
    ...
    observeEvent(input$sector_filter, {
      ...
      protocol_r()$set(field = "tools",
                       role = "tool_obs_latrine_iphra_v2",
    ...
    observeEvent(session$userData$flags$project_loaded, {
      ...
      tool  <- proto$tools[["tool_obs_latrine_iphra_v2"]]
    ...
    observeEvent(input$sector_filter, {
      iphra_save_tool_field(
        protocol_r()$tools[["tool_obs_latrine_iphra_v2"]],
    ...
    observeEvent(input$selected, {
      phrutils::phr_try({
        ...
        tool <- protocol_r()$tools[["tool_obs_latrine_iphra_v2"]]
        if (!is.null(tool)) {
          tool$set(
        ...
        protocol_r()$tools$tool_obs_latrine_iphra_v2$filter_survey_by_indicator(indicator_codes = indicators_selected$indicator_code)
        ...
        phrutils::phr_message(
          ...
          origin = phrutils::phr_txt("Latrine Observation Tool: Selection Sync")
        )
      },
      on_error = "warn",
      origin = phrutils::phr_txt("Latrine Observation Tool: Selection Sync"),
    ...
    observeEvent(input$preset_obj_latrine_obs, {
      phrutils::phr_try({
        ...
        }, step = "mod_tools_latrine_obs_server/observeEvent_preset_obj_latrine_obs/Validation")
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            phrutils::phr_txt("Latrine Observation objectives preset applied successfully."),
            origin = phrutils::phr_txt("Latrine Observation Tool: Preset Objectives")
          )

        }, step = "mod_tools_latrine_obs_server/observeEvent_preset_obj_latrine_obs/Core Logic")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            phrutils::phr_txt("Latrine Observation objectives preset selection completed."),
            origin = phrutils::phr_txt("Latrine Observation Tool: Preset Objectives")
          )
    ...
    observeEvent(input$preset_core_latrine_obs, {
      phrutils::phr_try({
        ...
        result <- phrutils::phr_try_step({
          phrutils::phr_message(
            phrutils::phr_txt("Validation checks passed (dummy mode)."),
            origin = phrutils::phr_txt("Latrine Observation Tool: Preset Core")
          )
        }, step = "mod_tools_latrine_obs_server/observeEvent_preset_core_latrine_obs/Validation")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            phrutils::phr_txt("Latrine Observation core preset applied successfully."),
            origin = phrutils::phr_txt("Latrine Observation Tool: Preset Core")
          )
        ...
        }, step = "mod_tools_latrine_obs_server/observeEvent_preset_core_latrine_obs/Core Logic")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          phrutils::phr_message(
            phrutils::phr_txt("Latrine Observation core preset selection completed."),
            origin = phrutils::phr_txt("Latrine Observation Tool: Preset Core")
          )
        }, step = "mod_tools_latrine_obs_server/observeEvent_preset_core_latrine_obs/Result Handling")
        if (phrutils::phr_failed(result)) return(result)
    ...
    observeEvent(input$preset_full_latrine_obs, {
      phrutils::phr_try({
        ...
        result <- phrutils::phr_try_step({
          phrutils::phr_message(
            phrutils::phr_txt("Validation checks passed (dummy mode)."),
            origin = phrutils::phr_txt("Latrine Observation Tool: Preset Full")
          )
        }, step = "mod_tools_latrine_obs_server/observeEvent_preset_full_latrine_obs/Validation")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            phrutils::phr_txt("Full Latrine Observation preset applied successfully."),
            origin = phrutils::phr_txt("Latrine Observation Tool: Preset Full")
          )

        }, step = "mod_tools_latrine_obs_server/observeEvent_preset_full_latrine_obs/Core Logic")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          phrutils::phr_message(
            phrutils::phr_txt("Latrine Observation preset selection completed."),
            origin = phrutils::phr_txt("Latrine Observation Tool: Preset Full")
          )
        }, step = "mod_tools_latrine_obs_server/observeEvent_preset_full_latrine_obs/Result Handling")
        if (phrutils::phr_failed(result)) return(result)
    ...
    observeEvent(input$export_tool, {
      phrutils::phr_try({
        if (!isTRUE(protocol_r()$.tool_latrine_observation)) {
          shiny::showModal(shiny::modalDialog(
            title = phrutils::phr_txt("Export Latrine Observation Tool"),
            phrutils::phr_txt("The Latrine Observation tool has not been added to the protocol yet. Please add it from the Tool Design page before exporting."),
        ...
        shiny::showModal(shiny::modalDialog(
          title = phrutils::phr_txt("Export Latrine Observation Tool"),
          shiny::tagList(
            shiny::p(phrutils::phr_txt("Click below to save the Latrine Observation tool as an Excel workbook with three sheets: revised_survey, revised_choices, and revised_settings.")),
      ...
      on_error = "warn",
      origin = phrutils::phr_txt("Latrine Observation Tool: Export"),
      hint = phrutils::phr_txt("Ensure the Latrine Observation tool has been added to the protocol and exposes revised_survey / revised_choices / revised_settings.")
      )
    })

    output$download_tool <- shiny::downloadHandler(
      filename = function() {
        paste0("tool_obs_latrine_iphra_v2",
      ...
      content = function(file) {
        ...
        sheets <- list(
          survey   = safe_df(protocol_r()$tools$tool_obs_latrine_iphra_v2$revised_survey),
          choices  = safe_df(protocol_r()$tools$tool_obs_latrine_iphra_v2$revised_choices),
          settings = safe_df(protocol_r()$tools$tool_obs_latrine_iphra_v2$revised_settings)
        )

        writexl::write_xlsx(sheets, path = file)

        phrutils::phr_message(
          phrutils::phr_txt("Latrine Observation tool exported to Excel."),
          origin = phrutils::phr_txt("Latrine Observation Tool: Export")
        )
      }
    )
