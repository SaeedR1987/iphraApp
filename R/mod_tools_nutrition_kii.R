#' tools_nutrition_kii UI Function
#'
...
mod_tools_nutrition_kii_ui <- function(id) {
  ns <- NS(id)
  tagList(
    ...
    shiny::conditionalPanel(
      ...
      shiny::fluidRow(
        shinydashboard::box(
          title = "Nutrition Facility Key Informant Tool - Presets",
          width = 12,
          ...
          shiny::actionButton(ns("export_tool"), "Export Health Facility KII Tool", class = "btn-success"),
        )
      ),
      shiny::fluidRow(
        shiny::column(
...
#' tools_nutrition_kii Server Functions
#'
#' @noRd
mod_tools_nutrition_kii_server <- function(id){
  moduleServer(id, function(input, output, session){
    ...
    output$tool_present <- shiny::renderText({
      if (isTRUE(protocol_r()$.tool_nutrition_facility_kii)) "true" else "false"
    })
    ...
    all_indicators <- shiny::reactive({
      ...
      bank <- protocol_r()$framework$modified_indicator_bank[
        protocol_r()$framework$modified_indicator_bank$tool == "kii_nut_facility",
    ...
    output$summary_table <- shiny::renderTable({
      ...
      survey <- protocol_r()$tools$tool_kii_nutrition_service_provider_iphra_v2$revised_survey
    ...
    observeEvent(input$sector_filter, {
      ...
      protocol_r()$set(field = "tools",
                       role = "tool_kii_nutrition_service_provider_iphra_v2",
    ...
    observeEvent(session$userData$flags$project_loaded, {
      ...
      tool  <- proto$tools[["tool_kii_nutrition_service_provider_iphra_v2"]]
    ...
    observeEvent(input$sector_filter, {
      iphra_save_tool_field(
        protocol_r()$tools[["tool_kii_nutrition_service_provider_iphra_v2"]],
    ...
    observeEvent(input$selected, {
      phrutils::phr_try({
        ...
        tool <- protocol_r()$tools[["tool_kii_nutrition_service_provider_iphra_v2"]]
        if (!is.null(tool)) {
          tool$set(
        ...
        protocol_r()$tools$tool_kii_nutrition_service_provider_iphra_v2$filter_survey_by_indicator(indicator_codes = indicators_selected$indicator_code)
        ...
        phrutils::phr_message(
          ...
          origin = phrutils::phr_txt("Nutrition Facility KII Tool: Selection Sync")
        )
      },
      on_error = "warn",
      origin = phrutils::phr_txt("Nutrition Facility KII Tool: Selection Sync"),
    ...
    # Preset: Objectives
    observeEvent(input$preset_obj_nutrition_facility_kii, {
      phrutils::phr_try({
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            ...
            origin = phrutils::phr_txt("Nutrition Facility KII Tool: Preset Objectives")
          )


        }, step = "mod_tools_nutrition_facility_kii_server/observeEvent_preset_obj_nutrition_facility_kii/Validation")
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            phrutils::phr_txt("Nutrition Facility KII objectives preset applied successfully."),
            origin = phrutils::phr_txt("Nutrition Facility KII Tool: Preset Objectives")
          )

        }, step = "mod_tools_nutrition_facility_kii_server/observeEvent_preset_obj_nutrition_facility_kii/Core Logic")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            phrutils::phr_txt("Nutrition Facility KII objectives preset selection completed."),
            origin = phrutils::phr_txt("Nutrition Facility KII Tool: Preset Objectives")
          )
        }, step = "mod_tools_nutrition_facility_kii_server/observeEvent_preset_obj_nutrition_facility_kii/Result Handling")
        if (phrutils::phr_failed(result)) return(result)
    ...
    # Preset: Core
    observeEvent(input$preset_core_nutrition_facility_kii, {
      phrutils::phr_try({
        ...
        result <- phrutils::phr_try_step({
          phrutils::phr_message(
            phrutils::phr_txt("Validation checks passed (dummy mode)."),
            origin = phrutils::phr_txt("Nutrition Facility KII Tool: Preset Core")
          )
        }, step = "mod_tools_nutrition_facility_kii_server/observeEvent_preset_core_nutrition_facility_kii/Validation")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            phrutils::phr_txt("Nutrition Facility KII core preset applied successfully."),
            origin = phrutils::phr_txt("Nutrition Facility KII Tool: Preset Core")
          )
        ...
        }, step = "mod_tools_nutrition_facility_kii_server/observeEvent_preset_core_nutrition_facility_kii/Core Logic")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          phrutils::phr_message(
            phrutils::phr_txt("Nutrition Facility KII core preset selection completed."),
            origin = phrutils::phr_txt("Nutrition Facility KII Tool: Preset Core")
          )
        }, step = "mod_tools_nutrition_facility_kii_server/observeEvent_preset_core_nutrition_facility_kii/Result Handling")
        if (phrutils::phr_failed(result)) return(result)
    ...
    observeEvent(input$preset_full_obs, {
      phrutils::phr_try({
        ...
        result <- phrutils::phr_try_step({
          phrutils::phr_message(
            phrutils::phr_txt("Validation checks passed (dummy mode)."),
            origin = phrutils::phr_txt("Nutrition Facility KII Tool: Preset Full")
          )
        }, step = "mod_tools_nutrition_facility_kii_server/observeEvent_preset_full_nutrition_facility_kii/Validation")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          ...
          phrutils::phr_message(
            phrutils::phr_txt("Full Nutrition Facility KII preset applied successfully."),
            origin = phrutils::phr_txt("Nutrition Facility KII Tool: Preset Full")
          )

        }, step = "mod_tools_nutrition_facility_kii_server/observeEvent_preset_full_nutrition_facility_kii/Core Logic")
        if (phrutils::phr_failed(result)) return(result)
        ...
        result <- phrutils::phr_try_step({
          phrutils::phr_message(
            phrutils::phr_txt("Nutrition Facility KII preset selection completed."),
            origin = phrutils::phr_txt("Nutrition Facility KII Tool: Preset Full")
          )
        }, step = "mod_tools_nutrition_facility_kii_server/observeEvent_preset_full_nutrition_facility_kii/Result Handling")
        if (phrutils::phr_failed(result)) return(result)
    ...
    observeEvent(input$export_tool, {
      phrutils::phr_try({
        if (!isTRUE(protocol_r()$.tool_nutrition_facility_kii)) {
          shiny::showModal(shiny::modalDialog(
            title = phrutils::phr_txt("Export Nutrition Facility KII Tool"),
            phrutils::phr_txt("The Nutrition Facility KII tool has not been added to the protocol yet. Please add it from the Tool Design page before exporting."),
        ...
        shiny::showModal(shiny::modalDialog(
          title = phrutils::phr_txt("Export Nutrition Facility KII Tool"),
          shiny::tagList(
            shiny::p(phrutils::phr_txt("Click below to save the Nutrition Facility KII tool as an Excel workbook with three sheets: revised_survey, revised_choices, and revised_settings.")),
      ...
      on_error = "warn",
      origin = phrutils::phr_txt("Nutrition Facility KII Tool: Export"),
      hint = phrutils::phr_txt("Ensure the Nutrition Facility KII tool has been added to the protocol and exposes revised_survey / revised_choices / revised_settings.")
      )
    })

    output$download_tool <- shiny::downloadHandler(
      filename = function() {
        paste0("tool_kii_nutrition_service_provider_iphra_v2",
      ...
      content = function(file) {
        ...
        sheets <- list(
          survey   = safe_df(protocol_r()$tools$tool_kii_nutrition_service_provider_iphra_v2$revised_survey),
          choices  = safe_df(protocol_r()$tools$tool_kii_nutrition_service_provider_iphra_v2$revised_choices),
          settings = safe_df(protocol_r()$tools$tool_kii_nutrition_service_provider_iphra_v2$revised_settings)
        )

        writexl::write_xlsx(sheets, path = file)

        phrutils::phr_message(
          phrutils::phr_txt("Nutrition Facility KII tool exported to Excel."),
          origin = phrutils::phr_txt("Nutrition Facility KII Tool: Export")
        )
      }
    )
