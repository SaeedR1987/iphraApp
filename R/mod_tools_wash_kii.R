...
mod_tools_wash_kii_server <- function(id){
  moduleServer(id, function(input, output, session){
    ...
    observeEvent(input$selected, {
      iphra_try({
        ...
        iphra_message(
          ...
          origin = iphra_txt("WASH Service Provider KII Tool: Selection Sync")
        )
      },
      on_error = "warn",
      origin = iphra_txt("WASH Service Provider KII Tool: Selection Sync"),
      ...
      iphra_try({
        ...
        result <- iphra_try_step({
          ...
          iphra_message(
            ...
            origin = iphra_txt("WASH Service Provider KII Tool: Preset Objectives")
          )
        ...
        result <- iphra_try_step({
          ...
          iphra_message(
            iphra_txt("WASH Service Provider KII objectives preset applied successfully."),
            origin = iphra_txt("WASH Service Provider KII Tool: Preset Objectives")
          )
        ...
        result <- iphra_try_step({
          ...
          iphra_message(
            iphra_txt("WASH Service Provider KII objectives preset selection completed."),
            origin = iphra_txt("WASH Service Provider KII Tool: Preset Objectives")
          )
    ...
    observeEvent(input$preset_core_wash_kii, {
      iphra_try({
        ...
        result <- iphra_try_step({
          iphra_message(
            iphra_txt("Validation checks passed (dummy mode)."),
            origin = iphra_txt("WASH Service Provider KII Tool: Preset Core")
          )
        ...
        result <- iphra_try_step({
          ...
          iphra_message(
            iphra_txt("WASH Service Provider KII core preset applied successfully."),
            origin = iphra_txt("WASH Service Provider KII Tool: Preset Core")
          )
        ...
        result <- iphra_try_step({
          iphra_message(
            iphra_txt("WASH Service Provider KII core preset selection completed."),
            origin = iphra_txt("WASH Service Provider KII Tool: Preset Core")
          )
    ...
    observeEvent(input$preset_full_obs, {
      iphra_try({
        ...
        result <- iphra_try_step({
          iphra_message(
            iphra_txt("Validation checks passed (dummy mode)."),
            origin = iphra_txt("WASH Service Provider KII Tool: Preset Full")
          )
        ...
        result <- iphra_try_step({
          ...
          iphra_message(
            iphra_txt("Full WASH Service Provider KII preset applied successfully."),
            origin = iphra_txt("WASH Service Provider KII Tool: Preset Full")
          )
        ...
        result <- iphra_try_step({
          iphra_message(
            iphra_txt("WASH Service Provider KII preset selection completed."),
            origin = iphra_txt("WASH Service Provider KII Tool: Preset Full")
          )
    ...
    observeEvent(input$export_tool, {
      iphra_try({
        if (!isTRUE(protocol_r()$.tool_wash_provider_kii)) {
          shiny::showModal(shiny::modalDialog(
            title = iphra_txt("Export WASH Service Provider KII Tool"),
            iphra_txt("The WASH Service Provider KII tool has not been added to the protocol yet. Please add it from the Tool Design page before exporting."),
        ...
        shiny::showModal(shiny::modalDialog(
          title = iphra_txt("Export WASH Service Provider KII Tool"),
          shiny::tagList(
            shiny::p(iphra_txt("Click below to save the WASH Service Provider KII tool as an Excel workbook with three sheets: revised_survey, revised_choices, and revised_settings.")),
      ...
      on_error = "warn",
      origin = iphra_txt("WASH Service Provider KII Tool: Export"),
      hint = iphra_txt("Ensure the WASH Service Provider KII tool has been added to the protocol and exposes revised_survey / revised_choices / revised_settings.")
      )
    })
    ...
    output$download_tool <- shiny::downloadHandler(
      ...
      content = function(file) {
        ...
        iphra_message(
          iphra_txt("WASH Service Provider KII tool exported to Excel."),
          origin = iphra_txt("WASH Service Provider KII Tool: Export")
        )
      }
    )
